...
End: implementation commit recorded after commit creation. [Rules-to-service contract](../rules/combat-completion-contract.md) and [later screen handoff](../rules/combat-freeze-and-ui-handoff-2026-09-08.md) are updated. Backend passes are complete; replacement screens and human tabletop usability testing remain the subsequent phase.
