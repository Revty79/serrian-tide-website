...
export const CAMPAIGN_GRAPH_DELETE_STEPS = [
  ...
  { tableName: "campaign_session_scene_shop", scope: "campaign" },
  { tableName: "campaign_session_scene_town", scope: "campaign" },
  { tableName: "campaign_session_prepared_shop", scope: "campaign" },
  { tableName: "campaign_session_prepared_town", scope: "campaign" },
