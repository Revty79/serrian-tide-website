...
export const CAMPAIGN_GRAPH_DELETE_STEPS = [
  ...
  { tableName: "inventory_custody_event", scope: "character" },
  { tableName: "inventory_container_access", scope: "character" },
  { tableName: "inventory_instance_custody", scope: "character" },
  { tableName: "inventory_stack_custody", scope: "character" },
  { tableName: "inventory_container_substance", scope: "character" },
