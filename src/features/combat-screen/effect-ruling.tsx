...
export function EffectEvidence({ value, depth = 0 }: { value: unknown; depth?: number }) {
  ...
  const data = object(value), fields = ["amount", "baseDamage", "extraSuccesses", "grossDamage", "armor", "soak", "netDamage", "hitLocationName", "locationName", "reason", "explanation", "message", "instruction", "title", "description", "manualOutcome"];
