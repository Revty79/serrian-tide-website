...
export function MovementPanel({ scope, participantId, modes, disabled, hold, holding, refresh }: { scope: CombatScreenScope; participantId: number; modes: readonly { movementMode: string }[]; disabled: boolean; hold: boolean; holding: boolean; refresh: () => Promise<void> }) {
