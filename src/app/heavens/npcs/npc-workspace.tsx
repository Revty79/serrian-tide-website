...
export function NpcWorkspace({ campaigns }: { campaigns: CampaignAdminSummary[] }) {
  ...
  async function createRace() {
    ...
    try {
      ...
      router.push(`/heavens/characters/${created.character.id}?source=npcs&campaign=${campaignId}`);
    } catch (error) {
