      ...
      <div className="mx-auto w-full max-w-6xl">
        <header className="grid overflow-hidden rounded-3xl border border-white/10 bg-black/35 shadow-2xl backdrop-blur-md md:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="flex flex-col justify-center border-t border-white/10 px-8 py-8 md:border-l md:border-t-0 lg:px-12">
            ...
            <h2 className="font-sans mt-3 bg-gradient-to-r from-slate-100 via-amber-100 to-slate-100 bg-clip-text text-4xl text-transparent sm:text-5xl">
              The Heavens
            </h2>
        ...
        <section className="mt-7 rounded-3xl border border-white/10 bg-black/35 p-6 shadow-2xl backdrop-blur-md sm:p-8">
          <div className="flex flex-col gap-3 border-b border-white/10 pb-5 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h3 className="font-sans mt-2 text-3xl text-slate-100">Campaign Control</h3>
            </div>
        ...
        <section className="mt-7">
          <Link
            href={initialCampaignId ? `/heavens/tabletop?campaign=${initialCampaignId}` : "/heavens/tabletop"}
          ...
          >
            <div>
              ...
              <h3 className="font-sans mt-2 text-3xl text-slate-100">Tabletop Operations</h3>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">Plan, start, complete, and reopen Campaign Sessions while persistent Character and NPC state remains authoritative.</p>
            </div>
        ...
        <section className="mt-10">
          <div className="flex flex-col gap-3 border-b border-white/10 pb-5 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h3 className="font-sans mt-2 text-3xl text-slate-100">Create &amp; Manage Serrian Tide</h3>
            </div>
        ...
        <footer className="mt-8 flex items-center justify-between border-t border-white/10 pt-6">
          ...
          <span className="hidden text-xs tracking-[0.14em] text-slate-400 sm:block">SERRIAN TIDE</span>
        </footer>
      </div>
    </main>
  );
