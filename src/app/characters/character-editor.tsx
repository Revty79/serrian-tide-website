...
export function CharacterEditor({
  ...
  function changeItemQuantity(itemId: number, requestedQuantity: number) {
    ...
    if (getItemOwnershipStrategy(catalogItem.runtimeProfile, catalogItem.isFirearm === true) === "instance") {
      change((current) => ({
        ...current,
        ...
        itemInstances: resizeDraftOwnedItemInstances({
          ...
          requiresExactInstance: catalogItem.isFirearm === true,
