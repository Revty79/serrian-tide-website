...
export function CharacterEditor({
  ...
  function changeItemQuantity(itemId: number, requestedQuantity: number) {
    ...
    if (getItemOwnershipStrategy(catalogItem.runtimeProfile, catalogItem.isFirearm === true || catalogItem.isMagazine === true) === "instance") {
      change((current) => ({
        ...current,
