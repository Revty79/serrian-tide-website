...
export const weaponProfile = pgTable(
  "weapon_profiles",
  {
    ...
    drawInitiativeCost: integer("draw_initiative_cost"),
    readyInitiativeCost: integer("ready_initiative_cost"),
    reloadInitiativeCost: integer("reload_initiative_cost"),
    unloadInitiativeCost: integer("unload_initiative_cost"),
    firingModeChangeInitiativeCost: integer("firing_mode_change_initiative_cost"),
