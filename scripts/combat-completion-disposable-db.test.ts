...
test("combat completion service cases use a new disposable migrated PostgreSQL cluster", { timeout: 240_000 }, async () => {
  ...
  try {
    ...
    for (const script of ["scripts/magazine-catalog-repair-db.test.ts", "scripts/weapon-catalog-repair-db.test.ts", "scripts/weapon-skill-governance-db.test.ts", "scripts/magazine-inventory-db.test.ts", "scripts/combat-completion-checkpoints-db.test.ts", "scripts/combat-completion-participants-db.test.ts", "scripts/combat-completion-damage-db.test.ts", "scripts/combat-completion-freeze-db.test.ts", "scripts/combat-completion-spells-db.test.ts", "scripts/combat-completion-learned-spells-db.test.ts", "scripts/combat-completion-effects-db.test.ts", "scripts/combat-completion-items-abilities-db.test.ts", "scripts/combat-completion-firearms-db.test.ts", "scripts/combat-completion-xp-db.test.ts", "scripts/combat-completion-recovery-db.test.ts", "scripts/combat-completion-force-end-db.test.ts", "scripts/combat-completion-trace-db.test.ts", "scripts/combat-completion-participation-db.test.ts", "scripts/combat-completion-conditions-db.test.ts", "scripts/combat-completion-limbs-db.test.ts", "scripts/combat-completion-revival-db.test.ts", "scripts/combat-screens-service-db.test.ts"]) {
      let output: string;
